...
/**
 * &lt;p&gt;Java class for MeldungstypZWM-AGType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypZWM-AGType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeZWM-AGType"/&amp;gt;
...
@XmlType(name = "MeldungstypZWM-AGType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypZWMAGType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeZWMAGType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypZWMAGType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeZWMAGType }
     *     
     */
    public MeldungsattributeZWMAGType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeZWMAGType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypZWMAGType.Meldungspositionen }
     *     
     */
    public MeldungstypZWMAGType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypZWMAGType.Meldungspositionen value) {
