...
/**
 * &lt;p&gt;Java class for MeldungstypZWM-LEType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypZWM-LEType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeZWM-LEType"/&amp;gt;
...
@XmlType(name = "MeldungstypZWM-LEType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypZWMLEType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeZWMLEType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypZWMLEType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeZWMLEType }
     *     
     */
    public MeldungsattributeZWMLEType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeZWMLEType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypZWMLEType.Meldungspositionen }
     *     
     */
    public MeldungstypZWMLEType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypZWMLEType.Meldungspositionen value) {
