...
/**
 * &lt;p&gt;Java class for MeldungstypENTM-PVType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypENTM-PVType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeENTM-PVType"/&amp;gt;
...
@XmlType(name = "MeldungstypENTM-PVType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypENTMPVType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeENTMPVType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypENTMPVType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeENTMPVType }
     *     
     */
    public MeldungsattributeENTMPVType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeENTMPVType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypENTMPVType.Meldungspositionen }
     *     
     */
    public MeldungstypENTMPVType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypENTMPVType.Meldungspositionen value) {
