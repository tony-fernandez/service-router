...
/**
 * &lt;p&gt;Java class for MeldungstypRUEM-PVType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypRUEM-PVType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeRUEM-PVType"/&amp;gt;
...
@XmlType(name = "MeldungstypRUEM-PVType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypRUEMPVType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeRUEMPVType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypRUEMPVType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeRUEMPVType }
     *     
     */
    public MeldungsattributeRUEMPVType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeRUEMPVType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypRUEMPVType.Meldungspositionen }
     *     
     */
    public MeldungstypRUEMPVType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypRUEMPVType.Meldungspositionen value) {
