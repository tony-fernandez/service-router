...
/**
 * &lt;p&gt;Java class for MeldungstypABBM-PVType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypABBM-PVType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeABBM-PVType"/&amp;gt;
...
@XmlType(name = "MeldungstypABBM-PVType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypABBMPVType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeABBMPVType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypABBMPVType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeABBMPVType }
     *     
     */
    public MeldungsattributeABBMPVType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeABBMPVType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypABBMPVType.Meldungspositionen }
     *     
     */
    public MeldungstypABBMPVType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypABBMPVType.Meldungspositionen value) {
