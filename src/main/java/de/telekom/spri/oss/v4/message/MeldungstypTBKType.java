...
/**
 * &lt;p&gt;Java class for MeldungstypTBKType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypTBKType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeTBKType"/&amp;gt;
...
@XmlType(name = "MeldungstypTBKType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
@XmlSeeAlso({
    MeldungstypTBKAGType.class,
    MeldungstypTBKLEType.class
})
public abstract class MeldungstypTBKType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeTBKType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypTBKType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeTBKType }
     *     
     */
    public MeldungsattributeTBKType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeTBKType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypTBKType.Meldungspositionen }
     *     
     */
    public MeldungstypTBKType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypTBKType.Meldungspositionen value) {
