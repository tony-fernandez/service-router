...
/**
 * &lt;p&gt;Java class for MeldungstypVZMType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypVZMType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeVZMType"/&amp;gt;
...
@XmlType(name = "MeldungstypVZMType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypVZMType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeVZMType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypVZMType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeVZMType }
     *     
     */
    public MeldungsattributeVZMType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeVZMType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypVZMType.Meldungspositionen }
     *     
     */
    public MeldungstypVZMType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypVZMType.Meldungspositionen value) {
