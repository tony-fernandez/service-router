...
/**
 * &lt;p&gt;Java class for MeldungstypABM-PVType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypABM-PVType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeABM-PVType"/&amp;gt;
...
@XmlType(name = "MeldungstypABM-PVType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypABMPVType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeABMPVType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypABMPVType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeABMPVType }
     *     
     */
    public MeldungsattributeABMPVType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeABMPVType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypABMPVType.Meldungspositionen }
     *     
     */
    public MeldungstypABMPVType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypABMPVType.Meldungspositionen value) {
