...
/**
 * &lt;p&gt;Java class for MeldungstypAKM-PVType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypAKM-PVType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeAKM-PVType"/&amp;gt;
...
@XmlType(name = "MeldungstypAKM-PVType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypAKMPVType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeAKMPVType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypAKMPVType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeAKMPVType }
     *     
     */
    public MeldungsattributeAKMPVType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeAKMPVType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypAKMPVType.Meldungspositionen }
     *     
     */
    public MeldungstypAKMPVType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypAKMPVType.Meldungspositionen value) {
