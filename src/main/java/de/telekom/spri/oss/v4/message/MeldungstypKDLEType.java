...
/**
 * &lt;p&gt;Java class for MeldungstypKDLEType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypKDLEType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeKDLEType"/&amp;gt;
...
@XmlType(name = "MeldungstypKDLEType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypKDLEType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeKDLEType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypKDLEType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeKDLEType }
     *     
     */
    public MeldungsattributeKDLEType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeKDLEType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypKDLEType.Meldungspositionen }
     *     
     */
    public MeldungstypKDLEType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypKDLEType.Meldungspositionen value) {
