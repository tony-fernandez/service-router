...
/**
 * &lt;p&gt;Java class for MeldungstypERLM-PVType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypERLM-PVType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeERLM-PVType"/&amp;gt;
...
@XmlType(name = "MeldungstypERLM-PVType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypERLMPVType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeERLMPVType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypERLMPVType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeERLMPVType }
     *     
     */
    public MeldungsattributeERLMPVType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeERLMPVType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypERLMPVType.Meldungspositionen }
     *     
     */
    public MeldungstypERLMPVType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypERLMPVType.Meldungspositionen value) {
