...
/**
 * &lt;p&gt;Java class for MeldungstypENTMType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypENTMType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeENTMType"/&amp;gt;
...
@XmlType(name = "MeldungstypENTMType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypENTMType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeENTMType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypENTMType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeENTMType }
     *     
     */
    public MeldungsattributeENTMType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeENTMType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypENTMType.Meldungspositionen }
     *     
     */
    public MeldungstypENTMType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypENTMType.Meldungspositionen value) {
