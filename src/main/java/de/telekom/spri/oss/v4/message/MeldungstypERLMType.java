...
/**
 * &lt;p&gt;Java class for MeldungstypERLMType complex type.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="MeldungstypERLMType"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 *     &amp;lt;extension base="{http://spri.telekom.de/oss/v4/message}MeldungstypAbstractType"&amp;gt;
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="meldungsattribute" type="{http://spri.telekom.de/oss/v4/message}MeldungsattributeERLMType"/&amp;gt;
...
@XmlType(name = "MeldungstypERLMType", propOrder = {
    "meldungsattribute",
    "meldungspositionen"
})
public class MeldungstypERLMType
    extends MeldungstypAbstractType
{

    @XmlElement(required = true)
    protected MeldungsattributeERLMType meldungsattribute;
    @XmlElement(required = true)
    protected MeldungstypERLMType.Meldungspositionen meldungspositionen;
     ...
     * @return
     *     possible object is
     *     {@link MeldungsattributeERLMType }
     *     
     */
    public MeldungsattributeERLMType getMeldungsattribute() {
     ...
     *     
     */
    public void setMeldungsattribute(MeldungsattributeERLMType value) {
     ...
     * @return
     *     possible object is
     *     {@link MeldungstypERLMType.Meldungspositionen }
     *     
     */
    public MeldungstypERLMType.Meldungspositionen getMeldungspositionen() {
     ...
     *     
     */
    public void setMeldungspositionen(MeldungstypERLMType.Meldungspositionen value) {
